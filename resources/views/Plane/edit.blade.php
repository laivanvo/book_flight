<form action = "{{ route('plane.update',$planes->id) }}" method = "POST">
    @csrf
    @method('PUT')
...
<form>
    ...
    <div class = "form-group has-error">
		...
		<input  type = "text" class = "form-control" name = "name_plane" value = "{{ $planes->name_plane }}" placeholder = "name_plane"> 
...
@enderror
    ...
    <div class = "form-group has-error">
		...
		<input  type = "text" class = "form-control" name = "price" value = "{{ $planes->price }}" chair placeholder = "price"> 
        <span class = "help-block">Enter numbers only</span>
        @error('price')
<span class = "invalid-feedback" role = "alert">
    <strong style = "color: red">{{ $message }}</strong><br>
    ...
    <div class = "form-group has-error">
    	<label for = "Password" class = "control-label">image</label>
            ...
            <div>
                ...
                <input class = "form-control form-control-xl" value = "" name = "image" type = "file" id = "formFile">
            </div>
        @error('category_id')
<span class = "invalid-feedback" role = "alert">
    <strong style = "color: red">{{ $message }}</strong><br>
...
@enderror
    ...
    <div class = "form-group has-error">
    	<label for = "Password" class = "control-label">chair</label>
		<input  type = "number" class = "form-control" name = "chair" value = "{{ $planes->chair }}" placeholder = "chair"> 
        <span class = "help-block">Enter numbers only</span>
        @error('chair')
<span class = "invalid-feedback" role = "alert">
    <strong style = "color: red">{{ $message }}</strong><br>
...
@enderror
    ...
    <div class = "form-group has-error">
		...
		<input  type = "text" class = "form-control" name = "status" value = "{{ $planes->status }}" placeholder = "status"> 
        <span class = "help-block">Enter numbers only</span>
        @error('status')
<span class = "invalid-feedback" role = "alert">
    <strong style = "color: red">{{ $message }}</strong><br>
