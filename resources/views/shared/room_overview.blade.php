<section class = "page">
    ...
    <div class = "page-header" style = "background-image:url(assets/client/assets/images/header-1.jpg)">
        <div class = "container">
        ...
        <div class = "room-gallery">
            <div class = "container">
                <div class = "owl-slider owl-theme owl-slider-gallery">
                    ...
                    <div class = "item" style = "background-image:url(assets/client/assets/images/room-4.jpg)">
                        <img src = "assets/images/room-4.jpg" alt = "" />
                    </div>

                    <!--  =  =  =  slide item  =  =  =  -->

                    <div class = "item" style = "background-image:url(assets/client/assets/images/room-2.jpg)">
                    ...
                    <div class = "item" style = "background-image:url(assets/client/assets/images/room-1.jpg)">
