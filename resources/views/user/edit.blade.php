...
<form>
    ...
    <div class="form-group has-success">
		...
		<input  type="text" class="form-control" name="email" id="email" placeholder="Name" value="{{ $users->email }}">
        <span class="help-block">Enter text only</span>
        @error('name')
        <span class="invalid-feedback" role="alert">
        <strong style="color: red">{{ $message }}</strong>
	...
	<div class="form-group has-warning">
		...
		<input  type="text" class="form-control" name="password" id="password" placeholder="Phone" value="{{ $users->password }}"> 
